                ...
                <div className="header-top-left">
                    <div className="logo">
                        <div className="logo-main">
                            <span >BAOM<img src="https://baomoi-static.zadn.vn/favicons/favicon-32x32.png" alt="logo" />I</span>
                        </div>
            ...
            <div className="header-body">
                <div className="col-9 header-navbar">
                    <ul className="header-navbar-list">
                        ...
                        <li className="header-navbar-item" onClick={()=>setActive(!active)}><AiOutlineMenu /></li>
                    </ul>
                </div>
