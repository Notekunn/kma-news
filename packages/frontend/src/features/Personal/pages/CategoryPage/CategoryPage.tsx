...
const CategoryPage: React.FC = () => {
  ...
  return (
    ...
    //   </div>
    //   <Link to="/tao-muc">
    //     <button className="btn create-category">Tạo mục</button>
    //   </Link>
    // </div>
    <div className="form-create-category">
      ...
      <div className="form-main">
        <div className="item-form">
          <div className="input-form" onClick={focusInput1}>
            <label>Tên mục</label>
            <div className="input">
              <input type="text" placeholder='Nhập tên thư mục của bạn' ref={inputRef1} />
            </div>
          </div>
        </div>
        <div className="item-form">
